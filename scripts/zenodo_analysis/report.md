...
![ICU占有率の時系列プロット](icu_occupancy_timeseries.png)
...
この箱ひげ図は、上位5カ国の日次病院占有率の分布を示しています。フランスは中央値が最も高く、また四分位範囲も広いことが分かります。これは、フランスがパンデミック期間中に一貫して高い病院占有率を経験したことを示しています。
